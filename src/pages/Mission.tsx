        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: <FlaskConical />, text: "Design and execute research projects in basic and applied neurosciences.", image: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?q=80&w=400&auto=format&fit=crop" },
                { icon: <ShieldAlert />, text: "Implement prevention, evaluation, and intervention programs aimed at strengthening brain health.", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=400&auto=format&fit=crop" },
                { icon: <GraduationCap />, text: "Train and capacitate specialized human resources in neurosciences from an interdisciplinary approach.", image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=400&auto=format&fit=crop" },
                { icon: <Handshake />, text: "Establish national and international strategic alliances for scientific development and academic cooperation.", image: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop" },
                { icon: <Coins />, text: "Manage sustainable funding to guarantee the continuity and expansion of research and intervention projects.", image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=400&auto=format&fit=crop" },
                { icon: <Megaphone />, text: "Promote scientific outreach and education in brain health in culturally diverse contexts.", image: "https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=400&auto=format&fit=crop" }
              ].map((obj, index) => (
                <motion.div 
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
